...
# Image Path
dir_path = '/Users/krishnamehta/Desktop/Image Color Transfer/TrainingImgs'
image_path='/Users/krishnamehta/Desktop/Image Color Transfer/ICT_1.jpg'

# Parameters
k=10 # KMeans Colors
l=1000 # Smoothness Of Image
add_noise = False  # grain
...
def get_lrange(arr, lspace):
    ...
    for i in arr:
         ...
         l_values = np.linspace(0.0, 1.0, lspace)
